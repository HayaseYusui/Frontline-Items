...
export const ITEMS: ItemData[] = [
    ...
    //FN SCAR-H
    {
        ...
        /*マガジン価格*/mag_value: '$30[9] / $60[11] (6.5mm)',
        /*弾薬*/cartridge: '7.62mm×51 / 6.5mmクリードモア',
    ...
    // Condition Red Ordnance Mfg CR-7
    {
        ...
        /*遠距離*/r_long: '-20',
        /*貫通力*/penetration: '+6',
        /*非貫通D*/non_penetration_damage: '2D6+9',
        /*貫通D*/penetration_damage: '3D6+11',
        /*射程*/range: '500m',
        /*弾数*/mag_round: '10',
        /*必要筋力*/kinryoku: '両6/片-',
        /*CP*/size: '3×5',
        ...
        /*弾薬*/cartridge: '.338 Lapua Magnum (500 BLK)',
        /*全長*/item_width: '980mm',
    ...
    //Armscor VR80-A
    {
        ...
        /*機能*/efficiency: [
            '部位狙い不可',
            '距離別貫通/ダメージ ',
            '[至近]:+2/3D6+2/4D6+4 [中]:+0/1D6+2/2D6+4',
    ...
    //Daewoo U.S.AS12
    {
        ...
        /*機能*/efficiency: [
            '部位狙い不可',
            '距離別貫通/ダメージ ',
            '[至近]:+3/3D6+2/4D6+4 [中]:+1/1D6+2/2D6+4',
    ...
    //MetalStorm MAUL
    {
        ...
        /*機能*/efficiency: [
            '部位狙い不可',
            '距離別貫通/ダメージ',
            '[至近]:+2/3D6+1/4D6+3 [中]:+0/1D6+1/2D6+2',
            '補器(下)',
            '射撃ファンブル表+2',
            '特殊弾薬不可'
        ],
    ...
    //MPS AA-12
    {
        ...
        /*機能*/efficiency: [
            '部位狙い不可',
            '距離別貫通/ダメージ ',
            '[至近]:+2/3D6+3/4D6+4 [中]:+0/1D6+2/2D6+4'
        ],
    ...
    //Diamondback Firearms DBX
    {
        ...
        /*説明*/note: 'DiamondBack社のAR-15派生のPDW。最近の流行に乗り、FN57のマガジンを使用する。小型軽量でハンドリングが軽快。ストックを外したモデルがハンドガンとして扱われる事もある。'
    },
    ...
    //Maxim Defense MDX:510
    {
        ...
        /*機能*/efficiency: [
            '.300 AAC Blackout使用時:貫通+4/2D6+3/3D6+4/消音4',
            'フル-10%'
        ],
        /*説明*/note: 'MAXIM DEFENSEが開発したPDW。扱い易いハンドガードが特徴。弾薬は拳銃弾ではなく小銃弾である5.56NATO弾か新型の300BLKの選択式である。'
    },
    // #endregion
    ...
    // #region 武器戦闘
    {
        ...
        /*機能*/efficiency: [
            ...
            '抜き打ちルール適用不可(居合は可能)',
            '盾として利用することが可能',
            '盾による遮蔽:5×[武器戦闘]Lv% 装甲値:12 防御値:3'
        ],
        /*説明*/note: '両手剣。銃が普及した現代においては無用の長物だが、その破壊力は現代の装甲には驚異となる。このデータは日本の大太刀なども含むため全長・重量はこのデータの限りではない。'
    },
    {
